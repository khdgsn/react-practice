...
function App() {
  let text = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis harum quisquam."
  let speech = "hello world"

  let imageOne = "https://pbs.twimg.com/profile_images/447374371917922304/P4BzupWu.jpeg"
  let imageTwo = "https://icatcare.org/app/uploads/2019/09/The-Kitten-Checklist-1.png"
  
  arr = [
    {author: "kath", story : "words wokjadf;ljas d" , img: "address"}
    ]
